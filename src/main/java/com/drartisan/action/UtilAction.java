...
public class UtilAction {
	...
	@ResponseBody
	public String uploadImg(HttpServletRequest request,@RequestParam MultipartFile file,String goodsname,String subgoodsnanme,int goodsid,int subgoodsid, int level,int index) {
...
//		}
		String filename,url;
		if (level==1) {
			filename = goodsname+hz;
			url = "resources/images/gallery/"+ filename;
		}else if (level == 2) {
			filename = goodsid+"-"+subgoodsid+hz;
			url = "resources/images/gallery/"+ goodsname +"/"+ filename;
		}else {
			filename = goodsid+"-"+subgoodsid+"-"+index+hz;
			url = "resources/images/gallery/"+ goodsname + subgoodsnanme +"/"+ filename;
		}
